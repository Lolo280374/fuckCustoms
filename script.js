...
const originCountryEl = document.getElementById('origin-co');
...
const originList = countries.filter(c => c.value === 'US' || c.value === 'GB');
const originChoice = new Choices(originCountryEl, {
    choices: originList,
    searchEnabled: false,
    itemSelectText: '',
    shouldSort: false
...
const destChoice = new Choices(destinationCountryEl, {
    choices: countries,
    searchEnabled: true,
    itemSelectText: '',
    shouldSort: false
